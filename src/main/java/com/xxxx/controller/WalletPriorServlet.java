...
@WebServlet("/prior_changing")
public class WalletPriorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String isPr = request.getParameter("isPrior");

        // 调用业务层方法验证
        MessageModel messageModel = walletService.changePrior(uid,sos,isPr);
